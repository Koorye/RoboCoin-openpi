...
def main(config_name: str, max_frames: int | None = None, *, use_fast_stats: bool = True, per_device_batch: int = 128, num_workers: int = 16):
    ...
    data_loader = _data_loader.TorchDataLoader(
        ...
        num_workers=num_workers,  # More workers for faster loading
        shuffle=shuffle,
